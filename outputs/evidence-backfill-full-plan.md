...
> Generated from site data. Dataset cut: 2026-07-24.
...
- Models without A-grade cases: 17
...
- All-model A-case deficit to minimum line: 51
- All-model A-case deficit to full target line: 85
- Backfill rows: 133
- P0 rows: 0
- P1 rows: 0
- P2 rows: 116
