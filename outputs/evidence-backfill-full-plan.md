...
> Generated from site data. Dataset cut: 2026-07-22.
...
- Models without A-grade cases: 12
...
- All-model A-case deficit to minimum line: 36
- All-model A-case deficit to full target line: 60
- Backfill rows: 128
- P0 rows: 0
- P1 rows: 0
- P2 rows: 116
